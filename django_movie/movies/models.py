...
class Category(models.Model):
    '''Категории'''
    name =models.CharField('Категории', max_length=155)
    description =models.TextField('Описавние')
...
class Movie(models.Model):
    ...
    description = models.TextField('Описание')
    trailer = models.CharField('Трейлер',default='')
    ...
    def youtube_video_id(self):
        """Извлекает идентификатор видео из ссылки на YouTube."""
        return self.trailer.split("https://www.youtube.com/watch?v=")[-1]
...
class Reviews(models.Model):
    ...
    def __str__(self):
        return f"{self.name} - {self.movie} parent {self.parent}"
